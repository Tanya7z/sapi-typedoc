...
| `2.10.0` | `1.26.40` | `1.26.50.24` | 2026-06-02 | 预览 |
...
| `2.2.0` | `1.26.40` | `1.26.50.24` | 2026-05-19 | 预览 |
...
| API 版本 | 稳定分支 MC | 预览分支 MC | 首次发布 | 备注 |
| --- | --- | --- | --- | --- |
| `1.0.0` | `1.26.40` | `1.26.50.24` | 2022-09-26 | 文档站 / 稳定 / 预览 |
| `0.0.1` | - | - | 2022-09-22 | - |
...
| API 版本 | 稳定分支 MC | 预览分支 MC | 首次发布 | 备注 |
| --- | --- | --- | --- | --- |
| `1.0.0` | `1.26.40` | `1.26.50.24` | 2024-01-24 | 文档站 / 稳定 / 预览 |
...
| API 版本 | 稳定分支 MC | 预览分支 MC | 首次发布 | 备注 |
| --- | --- | --- | --- | --- |
| `1.0.0` | `1.26.40` | `1.26.50.24` | 2025-02-05 | 文档站 / 稳定 / 预览 |
...
| API 版本 | 稳定分支 MC | 预览分支 MC | 首次发布 | 备注 |
| --- | --- | --- | --- | --- |
| `1.0.0` | `1.26.40` | `1.26.50.24` | 2022-09-27 | 文档站 / 稳定 / 预览 |
...
| API 版本 | 稳定分支 MC | 预览分支 MC | 首次发布 | 备注 |
| --- | --- | --- | --- | --- |
| `0.1.0` | `1.26.40` | `1.26.50.24` | 2023-06-28 | 文档站 / 稳定 / 预览 |
...
| API 版本 | 稳定分支 MC | 预览分支 MC | 首次发布 | 备注 |
| --- | --- | --- | --- | --- |
| `1.0.0` | `1.26.40` | `1.26.50.24` | 2022-09-27 | 文档站 / 稳定 |
...
| API 版本 | 稳定分支 MC | 预览分支 MC | 首次发布 | 备注 |
| --- | --- | --- | --- | --- |
| `1.0.0` | `1.26.40` | `1.26.50.24` | 2025-10-22 | 文档站 / 稳定 / 预览 |
